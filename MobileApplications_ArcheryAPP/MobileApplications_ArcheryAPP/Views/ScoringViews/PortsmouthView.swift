    ...
    var body: some View {
        ...
        VStack {
            ...
            Text("End Total: \(score)")
                .font(.title).padding().background(.yellow).foregroundColor(.black)
            ...
            HStack {
                ForEach(1...5, id: \.self) { number in
                    ...
                    }.font(.title).padding().background(Color.yellow)
                        .clipShape(Capsule())
                }
            }
            ...
            HStack {
                Text("Total Score: \(savedScores.reduce(0, +))")
                    .font(.title2).padding().background(.yellow).foregroundColor(.black)
                
                Text("Average: \(String(format: "%.2f", average))").font(.title2).padding().background(.yellow).foregroundColor(.black)
